...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="position-relative mx-n4 mt-n4">
                        <div class="profile-wid-bg profile-setting-img">
                            <img src="<?php if(isset($usuarios['foto'])){ echo $usuarios['foto']; } else { echo "vistas/assets/images/users/avatar-1.jpg"; }  ?>" class="profile-wid-img" alt="">
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                            <img src="<?php if(isset($usuarios['foto'])){ echo $usuarios['foto']; } else { echo "vistas/assets/images/users/avatar-1.jpg"; }  ?>" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                                        ...
                                        <h5 class="fs-16 mb-1"><?php echo $usuarios["nombre"].' '.$usuarios["apellido"]?></h5>
                                        <p class="text-muted mb-0"><?php echo $usuarios["perfil"]?></p>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" placeholder="Enter your firstname" value="<?php echo $usuarios["nombre"]?>">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="lastnameInput" placeholder="Enter your lastname" value="<?php echo $usuarios["apellido"]?>">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="phonenumberInput" placeholder="Enter your phone number" value="<?php echo $usuarios["telefono"]?>">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control" id="emailInput" placeholder="Enter your email" value="<?php echo $usuarios["email"]?>">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" data-provider="flatpickr" id="JoiningdatInput" data-date-format="d M, Y" data-deafult-date="24 Nov, 2021" placeholder="<?php echo $usuarios["fecha_registro"]?>" />
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="websiteInput1" placeholder="www.example.com" value="www.hv.com" />
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="cityInput" placeholder="City" value="<?php echo $usuarios["ciudad"]?>" />
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="countryInput" placeholder="Country" value="<?php echo $usuarios["pais"]?>" />
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" minlength="5" maxlength="6" id="zipcodeInput" placeholder="Enter zipcode" value="">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-12">
                                                        <div class="mb-3 pb-2">
                                                            ...
                                                            <textarea class="form-control" id="exampleFormControlTextarea" placeholder="Enter your description" rows="3"><?php echo $usuarios["descripcion"]?>.</textarea>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-12">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            ...
                                                            <a href="inicio" type="button" class="btn btn-soft-success">Cancel</a>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                </div>
    ...
    <script src="vistas/assets/js/pages/profile-setting.init.js"></script>