                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="id_patrocinador" value="<?php echo htmlspecialchars(ControladorUsuarios::codigoPatrocinadorUnico()); ?>">
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="pills-info-desc" role="tabpanel" aria-labelledby="pills-info-desc-tab">
                                        ...
                                        <div class="d-flex align-items-start gap-3 mt-4">
                                            ...
                                            <button type="button" class="btn btn-success btn-label right ms-auto nexttab" data-nexttab="pills-success-tab">
